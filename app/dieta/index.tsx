...
export default function Dieta() {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      if (!user) {
        Alert.alert("Erro", "Você precisa estar logado para ver seu plano alimentar.");
        setLoading(false);
        return;
      }

      setLoading(true);
      const collectionRef = firestore.collection('plano_alimentar');
  ...
  const handleCardPress = (id: string) => {
    // Passa o ID da dieta para a tela de edição
    router.push({
  ...
  return (
    <View style={styles.container}>
      <Header
        ...
        text='Acompanhe sua alimentaçao diária de forma organizada'
      />
      <TouchableOpacity style={styles.button} onPress={() => router.push('/dieta/FormAdicionar/formAdicionar')}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={{alignItems: 'center', marginTop: 50}}>
              ...
              <Text>Clique em "Adicionar Refeição" para começar!</Text>
            </View>
          }
        />
      )}
